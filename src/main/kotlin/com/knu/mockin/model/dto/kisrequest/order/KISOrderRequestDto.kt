package com.knu.mockin.model.dto.kisrequest.order
...
data class KISOrderRequestDto(
    ...
    @JsonProperty("CTAC_TLNO") val contactTelephoneNumber: String?,   // 연락전화번호
    @JsonProperty("MGCO_APTM_ODNO") val managementDesignatedOrderNumber: String?,   // 운용사지정주문번호
    @JsonProperty("SLL_TYPE") val saleType: String?,                  // 판매유형
    @JsonProperty("ORD_SVR_DVSN_CD") val orderServerDivisionCode: String,           // 주문서구분코드
